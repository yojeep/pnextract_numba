...
import numpy as np
from _edt_numba import nb_edt as edt
import numba as nb
import numpy.linalg as LA
import matplotlib.pyplot as plt
from scipy.ndimage import gaussian_filter

# image = np.fromfile(r"./image_100_300_300.raw", dtype=np.uint8).reshape(300, 300, 100)
# image = image == 0
...
moveUphill(ball_indices, ball_findices, ball_R, image, dt)
sorted_indices = np.argsort(ball_R, kind="stable")[::-1]
