...
| ----------------------------- | ------- | --------- | ------------- | --------------------- |
| Classical PNE (Single Thread) | 1       | 1689      | 129.3 s       | Baseline              |
| Classical PNE (64 Threads)    | 64      | 1689      | 37.5 s       | Parallelized C++      |
| pnextract_numba (64 Threads)  | 64      | 1693      | 14.6s         | Python implementation |
